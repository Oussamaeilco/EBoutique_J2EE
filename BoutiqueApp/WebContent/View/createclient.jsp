						...
						<div style="color: orange; text-align: center;" id="central_page">
							...
							<form action="../CreateClient" method="get">
								<table style="margin: 0 auto;">
									<tr><td style="color: orange;">Nom:</td><td><input type="text" id="nom" name="nom"></td></tr>
									...
									<tr><td style="color: orange;">Tel:</td><td><input type="text" id="telephone" name="telephone"></td></tr>
									<tr><td style="color: orange;">Adresse:</td><td><input type="text" id="adresse" name="adresse"></td></tr>
									<tr><td><input type="submit" value="Valider"></td><td/></tr>
								</table>
							</form>
						</div>
					</td>
